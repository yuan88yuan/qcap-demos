...
CXXFLAGS=--sysroot=${SDKTARGETSYSROOT} -I${SDKTARGETSYSROOT}/usr/include/aarch64-linux-gnu -std=c++11
CFLAGS=--sysroot=${SDKTARGETSYSROOT} -I${SDKTARGETSYSROOT}/usr/include/aarch64-linux-gnu
LDFLAGS=--sysroot=${SDKTARGETSYSROOT} -L${SDKTARGETSYSROOT}/usr/lib/aarch64-linux-gnu -Wl,-rpath-link=${SDKTARGETSYSROOT}/usr/lib/aarch64-linux-gnu \
