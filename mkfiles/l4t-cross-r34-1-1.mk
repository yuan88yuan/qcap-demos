...
CXXFLAGS=-I${SDKTARGETSYSROOT}/usr/include/aarch64-linux-gnu -std=c++11
CFLAGS=-I${SDKTARGETSYSROOT}/usr/include/aarch64-linux-gnu
LDFLAGS=-L${SDKTARGETSYSROOT}/usr/lib/aarch64-linux-gnu -Wl,-rpath-link=${SDKTARGETSYSROOT}/usr/lib/aarch64-linux-gnu \
